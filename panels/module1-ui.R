...
source("C:\\users\\casper\\Desktop\\StatsQC\\MSstatsqc-gui-v2.0\\src\\components\\common_css.R")
...
useShinyFeedback(),
  navbarPage(id = "inTabset",
    theme = 'cosmo.min.css', position = 'fixed-top',
             ...
             tabPanel(title= "About", value = "panel1", 
                      fluidPage(style= 'font-size: 18px;',
                                useShinyFeedback(),
                                fluidRow(column(8,offset = 2,
                                includeMarkdown("C:\\Users\\casper\\Desktop\\StatsQC\\MSstatsqc-gui-v2.0\\www\\mod1.md"),
                                actionButton("jumpToP2","Begin")
                                )))),
             
             tabPanel(title = "Tool",value = "panel2", id='upload_tab',
  ...
  fixedPanel(
    actionButton("switch_home", "switch_home"),
    left = 15,
    bottom = 15
  ),
)
